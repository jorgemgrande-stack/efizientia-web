/**
 * Efizientia SaaS · Panel Admin — Layout
 * Sidebar fijo en desktop, hamburger en mobile.
 * Design dark tech: fondo #0a0a0a, sidebar #111111, magenta #e91e8c.
 */
      ...
      >
        ...
        <div className="p-6" style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
          ...
          <div className="mt-3 flex items-center gap-2">
            <ShieldCheck size={12} style={{ color: "#e91e8c" }} />
            <span className="text-xs font-semibold uppercase tracking-widest" style={{ color: "#e91e8c" }}>
              Panel Admin
            </span>
          </div>
        </div>
        ...
        <div className="px-6 py-4" style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ background: "linear-gradient(135deg, #e91e8c, #7b2ff7)", color: "#fff" }}
            >
              {initial}
            </div>
            <div className="min-w-0">
              <div className="text-white font-semibold text-sm truncate">{user?.name}</div>
              <div className="text-xs font-bold uppercase tracking-widest" style={{ color: "#e91e8c" }}>
                Administrador
              </div>
            </div>
          </div>
